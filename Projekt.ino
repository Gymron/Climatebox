...
void setup() {
  ...
  pinMode(A15, INPUT);                //A15 Input TMP36 Wasser
  pinMode(32, OUTPUT);                //D32 Failsave-LED
  pinMode(51, OUTPUT);                //D51 Grün (Piezo-Fogger)
  pinMode(52, OUTPUT);                //D52 Gelb (Heizstab Wasser)
  pinMode(53, OUTPUT);                //D53 Rot (Wärmelampe)
